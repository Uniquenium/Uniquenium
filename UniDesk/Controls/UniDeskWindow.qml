...
Window {
    ...
    property Item appBar: UniDeskAppBar {
        title: window.title
        height: 30
    ...
    property color resizeBorderColor: {
        if (window.active) {
            return !UniDeskGlobals.isLight ? Qt.rgba(51 / 255, 51 / 255, 51 / 255, 1) : Qt.rgba(110 / 255, 110 / 255, 110 / 255, 1);
        }
        return !UniDeskGlobals.isLight ? Qt.rgba(61 / 255, 61 / 255, 61 / 255, 1) : Qt.rgba(167 / 255, 167 / 255, 167 / 255, 1);
    }
    ...
    color: UniDeskUtils.isSoftware() ? window.backgroundColor : "transparent"
    ...
    UniDeskFrameless {
        ...
        isDarkMode: !UniDeskGlobals.isLight
        Component.onCompleted: {
    ...
    Component {
        ...
        Item {
            Rectangle {
                ...
                anchors.fill: parent
                radius: Window.window.visibility === Window.Maximized ? 0 : 5
            ...
            Image {
                ...
                function updateLayout() {
                    var geometry = UniDeskUtils.desktopAvailableGeometry(window);
            ...
            UniDeskAcrylic {
                ...
                cornerRadius: Window.window.visibility === Window.Maximized ? 0 : 5
                blurRadius: window.blurRadius
                visible: window.active 
                tintColor: !UniDeskGlobals.isLight ? Qt.rgba(0, 0, 0, 1) : Qt.rgba(1, 1, 1, 1)
    ...
    Item {
        ...
        Loader {
            ...
            anchors.fill: parent
            sourceComponent: {
                if (window.useSystemAppBar || UniDeskUtils.isWin() || window.visibility === Window.Maximized || window.visibility === Window.FullScreen) {
                    return undefined;
                }
                return com_border;
            }
    ...
    function moveWindowToDesktopCenter() {
        var availableGeometry = UniDeskUtils.desktopAvailableGeometry(window);
    ...
    function deleteLater() {
        UniDeskUtils.deleteLater(window);
    }

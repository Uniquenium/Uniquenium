...
T.Slider {
    ...
    handle: Rectangle {
        ...
        implicitHeight: 20
        radius: 10
        color:UniDeskGlobals.isLight ?Qt.rgba(1,1,1,1): Qt.rgba(69/255,69/255,69/255,1) 
        UniDeskShadow{
            radius: 10
        }
        Rectangle{
    ...
    background: Item {
        ...
        Rectangle{
            ...
            anchors.margins: 1
            radius: 2
            color:UniDeskGlobals.isLight ? Qt.rgba(138/255,138/255,138/255,1) : Qt.rgba(162/255,162/255,162/255,1)
        }

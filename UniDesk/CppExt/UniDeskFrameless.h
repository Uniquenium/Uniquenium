...
class UniDeskFrameless : public QQuickItem, QAbstractNativeEventFilter {
    Q_OBJECT
    ...
    QML_NAMED_ELEMENT(UniDeskFrameless)
public:
    explicit UniDeskFrameless(QQuickItem* parent = nullptr);

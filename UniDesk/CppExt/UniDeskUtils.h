#ifndef UniDeskUtils_H
#define UniDeskUtils_H
 ...
 * @since Uniquenium 1.0
 */
class UniDeskUtils : public QObject {
    Q_OBJECT
    QML_NAMED_ELEMENT(UniDeskUtils)
    QML_SINGLETON

private:
    explicit UniDeskUtils(QObject* parent = nullptr);

public:
    SINGLETON(UniDeskUtils)

...
UniDeskFrameless::UniDeskFrameless(QQuickItem* parent)
    : QQuickItem { parent }
{
    _fixSize = false;
    _appbar = nullptr;
    ...
    _effect = "normal";
    _effective = false;
    _isWindows11OrGreater = UniDeskUtils::getInstance()->isWindows11OrGreater();
}

UniDeskFrameless::~UniDeskFrameless() = default;

[[maybe_unused]] void UniDeskFrameless::onDestruction()
{
    QGuiApplication::instance()->removeNativeEventFilter(this);
}

void UniDeskFrameless::componentComplete()
{
#ifdef Q_OS_WIN
    ...
    connect(this, &UniDeskFrameless::effectChanged, this, [hwnd, this] {
    ...
    connect(this, &UniDeskFrameless::useSystemEffectChanged, this, [this] {
        if (!_useSystemEffect) {
            effect("normal");
        }
    });
    connect(this, &UniDeskFrameless::isDarkModeChanged, this, [hwnd, this] {
    ...
    connect(this, &UniDeskFrameless::topmostChanged, this, [this] { _setWindowTopmost(topmost()); });
    _setWindowTopmost(topmost());
}

[[maybe_unused]] bool UniDeskFrameless::nativeEventFilter(const QByteArray& eventType, void* message,
...
bool UniDeskFrameless::_isMaximized()
{
    return window()->visibility() == QWindow::Maximized;
}

bool UniDeskFrameless::_isFullScreen()
{
    return window()->visibility() == QWindow::FullScreen;
}

void UniDeskFrameless::_showSystemMenu(QPoint point)
{
#ifdef Q_OS_WIN
...
bool UniDeskFrameless::_hitAppBar()
{
...
bool UniDeskFrameless::_hitMaximizeButton()
{
...
void UniDeskFrameless::_setMaximizePressed(bool val)
{
    if (_maximizeButton) {
...
void UniDeskFrameless::_setMaximizeHovered(bool val)
{
    if (_maximizeButton) {
...
void UniDeskFrameless::_updateCursor(int edges)
{
    switch (edges) {
    case 0:
...
[[maybe_unused]] void UniDeskFrameless::showFullScreen()
{
    window()->showFullScreen();
}

void UniDeskFrameless::showMaximized()
{
#ifdef Q_OS_WIN
    HWND hwnd = reinterpret_cast<HWND>(window()->winId());
    ::ShowWindow(hwnd, 3);
...
[[maybe_unused]] void UniDeskFrameless::showMinimized()
{
#ifdef Q_OS_WIN
    HWND hwnd = reinterpret_cast<HWND>(window()->winId());
    ::ShowWindow(hwnd, 2);
...
void UniDeskFrameless::showNormal()
{
    window()->setVisibility(QQuickWindow::Windowed);
}

void UniDeskFrameless::setHitTestVisible(QQuickItem* val)
{
...
void UniDeskFrameless::_setWindowTopmost(bool topmost)
{
#ifdef Q_OS_WIN
    HWND hwnd = reinterpret_cast<HWND>(window()->winId());
    if (topmost) {
...
bool UniDeskFrameless::eventFilter(QObject* obj, QEvent* ev)
{
#ifndef Q_OS_WIN
    switch (ev->type()) {
